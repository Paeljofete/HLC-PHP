...
<html>
	...
	<body>
		<h1 class="presenta">Login</h1><br/><br/><br/><br/>
		<form action=" " method="post">	
			<input type="text" id="email" name="email" placeholder="Introduce tu correo electrónico" <?php echo($email); ?>><br/><br/><br/><br/><br/><br/>
